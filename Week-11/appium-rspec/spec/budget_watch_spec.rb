...
describe 'Adding transactions' do
  ...
  it "should access the transaction page " do
    ...
    expect(@driver.find_element(:id, "protect.budgetwatch:id/search_button").displayed?).to eq true
  end
  ...
  it "should be able to add a transaction" do
    ...
    @driver.find_element(:id, "protect.budgetwatch:id/action_save").click
    @driver.find_element(:id, "protect.budgetwatch:id/").click
  end
