Feature: User login
  ...
  Scenario Outline: If I input incorrect email details I will receive the correct error message
    Given I am on the BBC home page
    And I move to the sign in page
    When I proceed to register
    And I select I am over 13
    ...
    | qwertyuiop | Sorry, that email doesn’t look right. Please check it's a proper email. |
